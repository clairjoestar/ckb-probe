...
│
├── docs/                                    # ← 所有文档集中于此
│   ├── getting-started_{en,zh}.md           # 从零开始使用指南
│   ├── docker-quickstart{,_zh}.md           # Docker 快速入门
│   ├── technical-deep-dive_{en,zh}.md       # 技术深度分析
│   ├── code-architecture{,_zh}.md           # 代码架构
│   ├── demo-walkthrough_{en,zh}.md          # 演示流程（五步，含真实输出）
│   ├── test-infrastructure_{en,zh}.md       # 本文档：测试基础设施指南
│   ├── STABILITY-REPORT{,_zh}.md            # 48h 稳定性测试报告
│   ├── CASE-STUDY-REPORT_zh.md              # 案例研究报告
│   ├── final-report_{en,zh}.md              # 结项报告
│   ├── monthly-report-final_{en,zh}.md      # 最终月度社区报告
